...
?>
	...
	<table align="center" width="100%">
		...
		<tr>
			<td colspan="15" class="labelTitRel" align="center" height="30"><span style="font-weight: bold;">RELA&Ccedil;&Atilde;O DE DIRIGENTES INSCRITOS</span></td>
		</tr>
  <tr>
  ...
  <?php 
	...
	, pessoa_fisica b		
				...
				and a.pessoa_fisica = b.codigo and b.dirigente_centro = 'S'
				:dataIni :dataFim
						...
						<table width="100%">
							<tbody><tr>
								<td class="labelColRel" align="left" height="5">
									<span style="font-weight: bold;">TOTAL DE DIRIGENTES INSCRITOS: &nbsp; <?php echo $linhas; ?></span>								</td>
							</tr>
						</tbody></table>					</td>
				</tr>
	</tbody></table>
