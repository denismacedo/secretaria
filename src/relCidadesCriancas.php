...
?>
	...
	<table align="center" width="100%">
		...
		<tr>
			<td colspan="3" class="labelTitRel" align="center" height="30"><span style="font-weight: bold;">QUANTIDADE DE CRIAN&Ccedil;AS POR CIDADE</span></td>
		</tr>
  <tr>
  	<td colspan="3" align="center">
  		<img src="imagens/barra_rel.jpg">
			...
			<td height="30" width="20%" class="labelColRel"><span style="font-weight: bold;"> ESTADO <a href="doRelatorio.php?method=cidadesCriancas&sortBy=F3" title="Ordenar"><img src="imagens/ordenar.png" alt="Ordenar" width="11" height="10" border="0" align="absmiddle"></a></span></td>
			<td width="40%" height="30" class="labelColRel"><span style="font-weight: bold;"> CIDADE <a href="doRelatorio.php?method=cidadesCriancas&sortBy=F1" title="Ordenar"><img src="imagens/ordenar.png" alt="Ordenar" width="11" height="10" border="0" align="absmiddle"></a></span></td>
			<td class="labelColRel" width="14%"><span style="font-weight: bold;"> PARTICIPANTES <a href="doRelatorio.php?method=cidadesCriancas&sortBy=F2" title="Ordenar"><img src="imagens/ordenar.png" alt="Ordenar" width="11" height="10" border="0" align="absmiddle"></a></span></td>
		</tr>
  ...
  <?php 
		...
		$sql = "select cidade.nome as cidade, estado.nome as estado, pais.nome as pais, count(insc.codigo) as inscritos
				from cidade cidade, estado estado, pais pais, pessoa_fisica pf, inscricao insc, evento evt, ocorrencia oco 
				...
				AND insc.evento = evt.codigo
				and insc.evento = oco.evento
				and insc.ocorrencia = oco.codigo
				 AND DATEDIFF(oco.inicio, pf.data_nasc)/365  < 12 
