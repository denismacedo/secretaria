...
//Guarda inicial
?><img src=imagens/p.gif width=<?php echo $fino; ?> height=<?php echo $altura; ?> border=0><img 
src=imagens/b.gif width=<?php echo $fino; ?> height=<?php echo $altura; ?> border=0><img 
src=imagens/p.gif width=<?php echo $fino; ?> height=<?php echo $altura; ?> border=0><img 
src=imagens/b.gif width=<?php echo $fino; ?> height=<?php echo $altura; ?> border=0><img 
<?php
$texto = $valor ;
if((strlen($texto) % 2) <> 0){
...
?>
    src=imagens/p.gif width=<?php echo $f1; ?> height=<?php echo $altura; ?> border=0><img 
<?php
    if (substr($f,$i,1) == "0") {
      $f2 = $fino ;
    }else{
...
?>
    src=imagens/b.gif width=<?php echo $f2; ?> height=<?php echo $altura; ?> border=0><img 
<?php
  }
}
...
// Draw guarda final
?>
src=imagens/p.gif width=<?php echo $largo;?> height=<?php echo $altura;?> border=0><img 
src=imagens/b.gif width=<?php echo $fino;?> height=<?php echo $altura;?> border=0><img 
src=imagens/p.gif width=<?php echo 1;?> height=<?php echo $altura;?> border=0> 
  <?php 
} //Fim da função
