...
//Guarda inicial
?><img src=../../boletophp/include/imagens/p.gif width=<?=$fino?> height=<?=$altura?> border=0><img 
src=../../boletophp/include/imagens/b.gif width=<?=$fino?> height=<?=$altura?> border=0><img 
src=../../boletophp/include/imagens/p.gif width=<?=$fino?> height=<?=$altura?> border=0><img 
src=../../boletophp/include/imagens/b.gif width=<?=$fino?> height=<?=$altura?> border=0><img 
<?
$texto = $valor ;
if((strlen($texto) % 2) <> 0){
...
?>
    src=../../boletophp/include/imagens/p.gif width=<?=$f1?> height=<?=$altura?> border=0><img 
<?
    if (substr($f,$i,1) == "0") {
      $f2 = $fino ;
    }else{
...
?>
    src=../../boletophp/include/imagens/b.gif width=<?=$f2?> height=<?=$altura?> border=0><img 
<?
  }
}
...
// Draw guarda final
?>
src=../../boletophp/include/imagens/p.gif width=<?=$largo?> height=<?=$altura?> border=0><img 
src=../../boletophp/include/imagens/b.gif width=<?=$fino?> height=<?=$altura?> border=0><img 
src=../../boletophp/include/imagens/p.gif width=<?=1?> height=<?=$altura?> border=0> 
  <?
} //Fim da função
