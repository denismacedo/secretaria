...
?>
      <FORM name=cadastroPJForm 
      action=doInscricao.php?method=getCentros 
      method=post><INPUT type=hidden name=tipoPJ> 
      <TABLE cellSpacing=3 cellPadding=3 width="100%" border=0>
        <TBODY>
        <TR>
          <TD><B>Nome: </B><INPUT maxLength=80 size=50 name="centro" id="centro" value="<?php echo getPost("centro"); ?>"> <INPUT 
